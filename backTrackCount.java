...
public class backTrackCount {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<ArrayList<Integer>>> path = printPaths(arr.length, new ArrayList<>(), new ArrayList<>(), 0, 0);
    ...
    static ArrayList<ArrayList<ArrayList<Integer>>> printPaths(int l, ArrayList<ArrayList<ArrayList<Integer>>> arr, ArrayList<ArrayList> newArr, int r, int c) {
        if (r >= l-1 && c >= l-1) {
